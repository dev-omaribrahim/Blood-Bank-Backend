    ...
    def get(self, request, *args, **kwargs):
        url_dict = {
            "Donation App": {
                ...
                "donation_detail": reverse("donation_app:donation_detail_view", args=["(pk:serial_number)"]),
                ...
                "donors_profiles_detail": reverse("donation_app:donors-detail", args=["(pk:id)"]),
                "institutes_list": reverse("donation_app:institutes-list"),
                "institutes_detail": reverse("donation_app:institutes-detail", args=["(pk:id)"]),
                "search": reverse("donation_app:search_view"),
            },
            "Money Manage App": {
                "receipt_list": reverse("money_manage_app:receipt_list"),
                "receipt_detail": reverse("money_manage_app:receipt_detail", args=["(pk:id)"]),
                "receipt_create": reverse("money_manage_app:receipt_create"),

                "bill_list": reverse("money_manage_app:bill_list"),
                "bill_detail": reverse("money_manage_app:bill_detail", args=["(pk:id)"]),
