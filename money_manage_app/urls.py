...
urlpatterns = [
    ...
    path("receipt/create/", views.ReceiptCreateAPIView.as_view(), name="receipt_create"),
    ...
    path("bill/validate_scan/", views.BillValidateScanAPIView.as_view(), name="bill_validate_scan"),
